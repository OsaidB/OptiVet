...
export default function Products() {
    ...
    return (
        ...
        //                         <Image source={ item.productImageUrl ? { uri: `${BASE_URL_IMAGES}${item.productImageUrl}` } : require('../../assets/images/box.png')} style={{ borderRadius: '100%', width: '100%', height: '100%' }} resizeMode="stretch"></Image>
        //                     </View>
