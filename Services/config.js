...
const BASE_URLS = {
    ...
    server: "https://optivet-backend-asdk.onrender.com", // Osaid's laptop base URL
...
const USED_BASE_URL = BASE_URLS.server5; // Change this to select a different base URL
